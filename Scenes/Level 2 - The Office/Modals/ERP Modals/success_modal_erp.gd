...
func _on_mission_complete_pressed() -> void:
	...
	if Global2.highest_unlocked_level < 4:
		Global2.highest_unlocked_level = 4
	# 1. Tell the Global script where the loading screen should take us
	Global.target_scene = "res://Scenes/Level 2 - The Office/Level 4 - Game Scene/E_Commerce_game_scene.tscn"
